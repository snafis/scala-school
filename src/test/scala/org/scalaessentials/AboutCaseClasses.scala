...
class AboutCaseClasses extends FunSpec with Matchers {

  // case classes are very convenient, they give you a lot for free. The following describes will
  // help you understand some of the conveniences. Case classes are also an integral part of
  // pattern matching which are the subject of separate describe

  describe("Case classes have an automatic equals method that works") {
  ...
  describe("Case classes have an automatic hashcode method that works") {
    case class Person(first: String, last: String)
  ...
  describe("Case classes have a convenient way they can be created") {
  ...
  describe("Case classes have a convenient toString method defined") {
    case class Dog(name: String, breed: String)
    val d1 = Dog("Scooby", "Doberman")
    d1.toString should be("Dog(Scooby,Doberman)")
  }

  describe("Case classes have automatic properties") {
    case class Dog(name: String, breed: String)
  ...
  describe("Case classes can have mutable properties") {
  ...
  describe("Safer alternatives exist for altering case classes") {
  ...
  describe("Case classes have default and named parameters") {
  ...
  describe("Case classes can be disassembled to their constituent parts as a tuple") {
    val p1 = Person("Fred", "Jones", 23, "111-22-3333")
