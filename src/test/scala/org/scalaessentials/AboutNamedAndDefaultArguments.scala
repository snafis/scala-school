...
class AboutNamedAndDefaultArguments() extends FunSpec with Matchers {
  ...
  describe("can specify arguments in any order if you use their names") {
    ...
    // for describe, remove the values in the should equal
    myColor should equal(255, 0, 0)
  }

  describe("can default arguments if you leave them off") {
    val me = new WithoutClassParameters()
  ...
  describe("can access class parameters and specify arguments in any order if you use their names") {
  ...
  describe("can access class parameters and default arguments if you leave them off") {
  ...
  describe("can default class parameters and have default arguments too") {
  ...
  describe("default parameters can be functional too") {
