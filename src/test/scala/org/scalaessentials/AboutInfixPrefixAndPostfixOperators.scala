...
class AboutInfixPrefixAndPostfixOperators extends FunSpec with Matchers {

  describe("""Simple: Infix Operators are available if an object
  ...
  describe("""Infix Operators do NOT work if an object
  ...
  describe("""Postfix operators work if an object
  ...
  describe("""Prefix operators work if an object
           |  has a method name that starts with unary_ .""") {
    val g: Int = 31
    (-31) should be(-31)
  }

  describe("""Here we create our own prefix operator for our own class.
